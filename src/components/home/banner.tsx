...
export const Banner = () => {
  return (
    <section className='h-[100vh] md:h-[120vh] lg:h-[130vh] w-full relative before:content-"" before:h-full before:w-full before:absolute before:bg-banner before:bg-cover before:bg-center before:brightness-50 before:bg-fixed'>
